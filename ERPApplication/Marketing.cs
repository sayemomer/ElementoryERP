    ...
    public partial class Marketing : Form
    {
        ...
        private void dataGrid2_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                this.textBox8.Text = row.Cells[9].Value.ToString();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                if ( Convert.ToDouble(this.textBox9.Text) <= Convert.ToDouble(this.textBox8.Text) )
                {
                    int id = Convert.ToInt32(this.textBox7.Text);
                ...
                {
                    MessageBox.Show("Insufficient Ammount");
                }
